...
namespace Sirenix.OdinInspector
{
    ...
    public sealed class ListDrawerSettingsAttribute : Attribute
    {
        ...
        /// <summary>
        /// Calls a method before each list element. The member referenced must have a return type of void, and an index paramater of type int which repricents the element index being drawn.
        /// </summary>
        public string OnBeginListElementGUI { get; set; }

        /// <summary>
        /// Calls a method after each list element. The member referenced must have a return type of void, and an index paramater of type int which repricents the element index being drawn.
        /// </summary>
